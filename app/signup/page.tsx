...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <div className="w-full h-[630px] max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8 sm:p-10">
            ...
            <span className='absolute  top-0 p-[10px] hover:cursor-pointer ' >
                <Link href={'/'}>
