    ...
    return (
        ...
        >
            <div className='border-[1px] rounded-[20px] border-none bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl flex flex-col  w-[35%] '>
                <h1 className=' text-center m-[20px] text-3xl block  font-bold leading-tight  bg-[white] bg-clip-text text-transparent text font-bold ' >Login to MockHire AI</h1>
                    ...
                    <form action="">
                        ...
                        <div>
                            ...
                            <div className='flex justify-center'>
                                <button className='bg-[white] text-black font-bold w-[83%]  p-[10px] rounded-[20px] hover:cursor-pointer'  >Login</button>
                            </div>
                            <div className='flex justify-center m-[20px]'>
                                Don't have an account?  <b className='hover:cursor-pointer' > <Link href={"/signup"}>Register</Link> </b>
